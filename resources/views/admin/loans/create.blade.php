            ...
            <form action="{{ route('admin.loans.store') }}" method="POST" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="user_id" id="member-select" class="mt-1 block w-full rounded-md border-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200" required>
                    ...
                    <div>
                        ...
                        <select name="loan_type_id" id="loan-type" class="mt-1 block w-full rounded-md border-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200" required>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="amount" id="amount" step="0.01" class="mt-1 block w-full rounded-md border-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="duration" id="duration" min="1" class="mt-1 block w-full rounded-md border-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200" required>
                            <p class="mt-1 text-sm text-gray-500" id="max-duration"></p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Start Date</label>
                            <input type="date" name="start_date" class="mt-1 block w-full rounded-md border-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="purpose" rows="3" class="mt-1 block w-full rounded-md border-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200" required></textarea>
                    </div>
                </div>
