    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="px-6 py-4 bg-purple-600">
                <h2 class="text-xl font-semibold text-white">Add New FAQ</h2>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="answer" rows="4" class="w-full rounded-lg border-gray-300" required
                                  style="border: 1px solid #ccc; font-size: 16px; border-radius: 5px; padding: 10px;">{{ old('answer') }}</textarea>
                    </div>
                    ...
                    <div class="flex justify-end space-x-4">
                        ...
                        <button type="submit"
                                class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700">Save FAQ</button>
                    </div>
                </div>
            </form>
        </div>
